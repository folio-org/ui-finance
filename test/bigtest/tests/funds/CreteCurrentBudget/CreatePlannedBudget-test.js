...
describe('Create planned budget', () => {
  setupApplication();
  ...
  describe('click on add new planned budget', () => {
    beforeEach(async function () {
      await fundDetails.plannedBudget.addBudgetButton.click();
    });

    it('open add planned budget modal', () => {
